...
const FeaturedProjects = () => {
  const projects = [
    ...
    },
    {
      id: 4,
      title: "Rencontre",
      client: "La grande journée des petits entrepreneurs",
      type: "Contenu de marque",
