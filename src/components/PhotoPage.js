          ...
          <div className="container">
            ...
            <div className="masonry-grid">
              {images.section1.map((image, index) => (
                ...
                >
                  <img src={image.src} alt={image.title} className="masonry-img" loading="lazy" />
              ...
              >
                {[...images.section2, ...images.section2].map((image, index) => (
                  <div
                    ...
                    onClick={() => handlePhotoClick(image.src, image.title)}
                  >
                    <img src={image.src} alt={image.title} className="card-img" loading="lazy" />
          ...
          <div className="container">
            ...
            <div className="hero-photo-grid">
              {images.section3.map((image, index) => (
                ...
                >
                  <img src={image.src} alt={image.title} className="hero-photo-img" loading="lazy" />
                </div>
              ))}
